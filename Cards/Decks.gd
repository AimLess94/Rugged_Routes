...
var collectableCards:CollectableCards = CollectableCards.new()
#Small Test Deck
...
var events:Deck = Deck.new([eventCards.bearAttack,eventCards.mischeviousSquirrel,eventCards.riverCrossing,collectableCards.birdPicture,collectableCards.mushroom,collectableCards.berries,collectableCards.deerAntlers])
